...
#            gt500.append(diag[:-2])
    ...
    to5 = sum(0 < x <= 5 for x in found_ind)
...
#    gt900 = sum(900 < x for x in found_ind)
    results = [first, to5, to10, to50, to100, to200]
    print model, ',' , ','.join([str(i) for i in results])
...
analyze('/Users/Eas/Documents/MATLAB/lsqisotonic_altered/mtv0/results/pro_init_NMDS_wW_1inAB')
analyze('/Users/Eas/Documents/MATLAB/lsqisotonic_altered/mtv0/results/pro_init_NMDS_proNormalized_wW_1inAB')
analyze('/Users/Eas/Documents/MATLAB/lsqisotonic_altered/mtv0/results/smooth_nmds_proNormalized_ver2')
