...
for row in rows:
    ...
    #if its not the same subject or if the admission time is one year after the last admission,
    # get the demographics with set_p_ffeatures
    # reset and make new sequence
